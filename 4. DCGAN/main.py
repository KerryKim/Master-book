...
parser.add_argument("--data_dir", default="./datasets/img)align_celeba", type=str, dest="data_dir")
...
parser.add_argument("--network", default="DCGAN", choices=["unet", "hourglass", "resnet", "srresnet", "DCGAN"],
                    type=str, dest="network")
